CREATE OR REPLACE FUNCTION CONSINCO.fInfoAdicionaisProdNFe (pnSeqNotaFiscal                IN MFL_DOCTOFISCAL.SEQNOTAFISCAL%TYPE,
...
BEGIN
  ...
  SELECT TRIM(
       SUBSTR((CASE WHEN vsPDEmiteObsEmergItemAItem = 'S' AND TRIM(psObsEmergencial) IS NOT NULL AND vsUfEmpresa = 'RJ' THEN
                 psObsEmergencial || ' '
               END) ||
